      ...
      describe "members" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before(:each) { FactoryGirl.create(:member, :name => "UniqueTitle") }
        ...
        describe "edit" do
          before(:each) { FactoryGirl.create(:member, :name => "A name") }
        ...
        describe "destroy" do
          before(:each) { FactoryGirl.create(:member, :name => "UniqueTitleOne") }
